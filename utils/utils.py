...
def load_data(data_name, transform, split_arr, batch_size=128, num_workers=8):
    '''
    ...
    train_dataloader = utils.NumpyDataLoader(train_set, batch_size=batch_size,
            shuffle=True, num_workers=num_workers)
    val_dataloader = utils.NumpyDataLaoder(val_set, batch_size=batch_size,
            shuffle=False, num_workers=num_workers)
    test_dataloader = utils.NumpyDataLaoder(test_set, batch_size=batch_size,
            shuffle=False, num_workers=num_workers)
